  ...
  switch (lines.length) {
    ...
    case 3: {
      switch (lines[0].length) {
		...
		errorformat =  `unrecognized document format. First line of input must have 30 (TD1), 36 (TD2 or French National Id), 44 (TD3) or 9 (Swiss Driving License) characters`;
		/*
          throw new Error(
