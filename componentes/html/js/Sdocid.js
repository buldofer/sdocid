...
/*
  function tess(imagen) {
    ...
    Tesseract.recognize(imagen, tesseractSettings).then(function(result) {
      ...
      if (!result.lines[0]) {
        ...
        if (!result.lines[1]) {
          cadenaurlconsultamrz = "http://localhost:5001/sdocid/us-central1/datosdoc?linea1=" + linea1;
        } else {
          ...
          cadenaurlconsultamrz =
            "http://localhost:5001/sdocid/us-central1/datosdoc?linea1=" + linea1 + "&linea2=" + linea2;
        ...
        if (!result.lines[2]) {
          ...
          cadenaurlconsultamrz =
            "http://localhost:5001/sdocid/us-central1/datosdoc?linea1=" +
            linea1 +
            "&linea2=" +
            linea2 +
            "&linea3=" +
  ...
  */
  ...
  async function crearimagen() {
    ...
    $.ajax({
      type: "POST",
      url: "http://localhost:5001/sdocid/us-central1/crearimgdoc",
      data: {
 ...
 async function getmrz() 
 {
       ...
       const response = await axios.get('http://localhost:5001/sdocid/us-central1/tess', {
          responseType: "text"
        }).then(function(res) {
  ...
  $("#buttondatosreserva").click(function () {
    ...
    $("#listaviviendasarevisar").css("height", "10%");
  ...
  $("#listaviviendasarevisar").change(function () {
